...
const BoardPage: React.FC<{ update: () => void }> = ({ update }) => {
  ...
  return (
    <div className="boardPage">
      ...
      <Board board={board} onBoardDelete={handleBoardDeleted} fetchBoards={update} onTitleChange={handleTitleChange} />
      ...
      <ModalForList isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSave={handleAddList} />
